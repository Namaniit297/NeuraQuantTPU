...
class AlexNet_CIFAR(nn.Module):
    def __init__(self):
        ...
        self.features = nn.Sequential(
            nn.Conv2d(3, 64, kernel_size=3, stride=1, padding=1),  # Modified for 32x32 input
            nn.BatchNorm2d(64),
...
# Quantization Functions (Same as before)
...
def main():
    ...
    pruner = LayerwiseMovementPruner(
        ...
        layer_target_sparsity={
            ...
            'features.3.weight': 0.7,
            'features.6.weight': 0.6,
            'features.8.weight': 0.5,
            'features.10.weight': 0.4,
            'classifier.1.weight': 0.3,
            'classifier.4.weight': 0.2,
    ...
    }, 'compressed_alexnet_cifar10.pth')
    print("Model saved as 'compressed_alexnet_cifar10.pth'")
